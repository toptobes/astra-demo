...
registerSetting('buffer-min-size', 'BUF_MIN_SIZ', 2, ...numInRange(1, 500));

registerSetting('buffer-add-size', 'BUF_ADD_SIZ', 6, ...numInRange(1, 500));

registerSetting('index-by', 'INDEXING_BY', 'sentence', (value) => {
